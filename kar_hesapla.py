...
# 1. Maliyet Çizelgesi Yükleme (CSV olarak güncellendi)
...
if maliyet_dosya and amazon_dosya:
    try:
        ...
        # Birim maliyetlerin sayısal formata dönüştürülmesi (CSV'de gelebilecek virgül/nokta karmaşası için)
    ...
    pd_st.info("💡 Lütfen sol menüden **Maliyet Çizelgesini (.csv)** ve **Amazon Finansal Raporunu** yükleyin.")
